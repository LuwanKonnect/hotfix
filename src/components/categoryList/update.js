...
export const UpdateCategory = () => {
    ...
    const [idFeedback, setIDFeedback] = useState(false)
    ...
    const addCategory = () => {
        checkName()
        checkAddress()
        if (_id.length > 0 && category_name.length > 0 && thumbnail_url.length > 0) {
            axiosInstance.put('/category/Update', {
                _id,
                category: {
                    category_name,
                    thumbnail_url
    ...
    return (
        <div style={{display: 'flex', flexDirection: 'row', marginBottom: -45, marginTop: -5}}>
            <Col className='pt-1 mt-2' xl='1' md='6' sm='12'>
                <FormGroup>
                    <span style={{fontSize: 18}}>Update:</span>
                </FormGroup>
            </Col>
            <Col className='ml-1 mb-1 pt-1' xl='3' md='6' sm='12'>
                <FormGroup>
                    <Label for='idInput'>Category ID</Label>
                    <Input type='text' id='idInput' onBlur = {checkID}
                           value = {_id} onChange = {e => setID(e.target.value)}
                           placeholder='Enter ID' invalid={idFeedback}/>
                    <FormFeedback>Please input a ID</FormFeedback>
                </FormGroup>
            </Col>
            <Col className='ml-1 mb-1 pt-1' xl='3' md='6' sm='12'>
                <FormGroup>
            ...
            <Col className='ml-2 mb-1 pt-1 mt-2' xl='1' md='1' sm='12'>
                <Row>
